...
const Daf = () => {
  ...
  const adminActions = [
    ...
    { id: '6', title: 'Creación de Recursos',  iconName: 'construct-outline',        route: '/admin/Inventario',         color: COLORS.warning,   description: 'Gestión de recursos del sistema',   badge: 'Nuevo', badgeColor: COLORS.accent },
    ...
    { id: '8', title: 'Reportes de DAF',     iconName: 'images-outline',           route: '/admin/ReportesDaf',          color: COLORS.info,      description: 'Administración de plantillas',       badge: 'Nuevo', badgeColor: COLORS.accent },
  ];
